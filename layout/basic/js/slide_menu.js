...
// ========== 여기작업 ============
    ...
    /* 1.회사소개 +누르면 하위 카테고리 생겨라 or 접어라 
       2.다른 카테고리가 열려있음 접어라*/
    $('.hamSlide__sub--flex').removeClass('selected');
    $('.hamSlide__sub--flex .company__more--click').click(function(){
        $('.hamSlide__sub--flex').toggleClass('selected');
        $('#aside .categoryList li#cate51').removeClass('selected');
        $('#aside .categoryList li#cate55').removeClass('selected');
        $('.community-cate').removeClass('selected');
    });

    /* 1.커뮤니티 +누르면 하위 카테고리 생겨라 or 접어라 
       2.다른 카테고리가 열려있음 접어라*/
    $('.community-cate').removeClass('selected');
    $('.community-cate .company__more--click').click(function(){
        $('.community-cate').toggleClass('selected');
        $('#aside .categoryList li#cate51').removeClass('selected');
        $('#aside .categoryList li#cate55').removeClass('selected');
        $('.hamSlide__sub--flex').removeClass('selected');
    });
    
    /* 1.제작가능상품 +누르면 다른 상품들 접어라
       2.제작가능상품은 열어라*/
    $('#aside .categoryList li#cate51 .company__more--click').click(function(){
        $('.hamSlide__sub--flex').removeClass('selected');
        $('#aside .categoryList li#cate55').removeClass('selected');
    ...
    /* 1.포트폴리오 +누르면 다른 상품들 접어라
       2.포트폴리오는 열어라*/
    $('#aside .categoryList li#cate55 .company__more--click').click(function(){
        $('.hamSlide__sub--flex').removeClass('selected');
        $('#aside .categoryList li#cate51').removeClass('selected');
        $(this).toggleClass('selected');
        $('.community-cate').removeClass('selected');
    ...
    $('#slideCateList li > a.cate').click(function(e) {
        ...
        if ($(this).parent().attr('class') == 'xans-record- selected') {
            $('#aside #slideCateList li').toggleClass('selected');
            methods.close();
        } else {
            if (!iCateNo) return;
            methods.close();
